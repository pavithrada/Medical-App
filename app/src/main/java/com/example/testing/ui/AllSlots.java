            ...
            DBSlots.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                    ...
                    for(DataSnapshot SlotSS : dataSnapshot.getChildren()){
                        ...
                        if(id.equals("N/A")){
                            Slot s = new Slot(timing,no,day,sid, pname);
                            slots.add(s);
                        }}
                    }
                    ...
                    lvAllSlots.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Slot sclicked = (Slot)slots.get(position); // a[0]
                            //sclicked.setId(pid);
                            ...
                            DBBooked.setValue(pid);// you need to use listeners to check whether data
                            DBBooked = FirebaseDatabase.getInstance().getReference("Dr Roopa Appointments/"+sclicked.getSid()+"/name");
